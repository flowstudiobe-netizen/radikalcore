    ...
    <div className="w-full border-b border-white/10 bg-bg/80 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.25em] text-muted">
        <div className="flex items-center gap-2">
          <span className="size-1.5 rounded-full bg-hazard pulse-warning shrink-0" aria-hidden />
          <span className="text-fg whitespace-nowrap">REISSUE / 2026</span>
          <span className="hidden sm:inline whitespace-nowrap">— SYSTEM ONLINE</span>
        </div>
